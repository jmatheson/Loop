...
enum PredictionInputEffect {
    ...
    func localizedDescription(forGlucoseUnit unit: HKUnit) -> String {
        ...
        case .retrospection:
            return NSLocalizedString("30 min comparison of glucose prediction vs actual, continued with decay over 120 min", comment: "Description of the prediction input effect for retrospective correction")
        }
    }
}
